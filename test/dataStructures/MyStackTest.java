...
public class MyStackTest {
        ...
        @Test public void pushOneElement_stackIsNotEmpty(){
            stack.push(13);
            assertFalse(stack.isEmpty());
        }

        @Test public void push_then_Pop_ShouldBeEmptyTest(){
            stack.push(10);
            stack.pop();
            assertTrue(stack.isEmpty());
        }

        @Test public void pushTwice_popOnce_ShouldNotBeEmpty(){
            stack.push(5);
            stack.push(5);
            stack.pop();
            assertFalse(stack.isEmpty());
        ...
        @Test public void pushingExcessElementsFailsTest(){
            stack.push(10);
            stack.push(20);
            stack.push(30);
            stack.push(40);
